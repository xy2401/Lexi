...
"Contract"来自拉丁语"contractus"（拉到一起），由"con-"（一起）和"trahere"（拉）构成。合同就是把双方"拉到一起"的协议。古罗马的合同刻在蜡板上，双方各执一半，合在一起验证真伪——这就是"counterpart"（对应副本）一词的由来。在中世纪英格兰，合同上滴蜡盖章是法律效力的象征，而"sign on the dotted line"（在虚线上签名）则是20世纪商业文化的产物。
...
- "you know"和"I mean"是英语口语中的"填充词"（filler words），面试中应适度使用，过多会显得不自信
- "shortly"表示"很快"，比"soon"更正式，常用于商务邮件："I will get back to you shortly"
