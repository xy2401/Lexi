...
本单元的场景是"对错误给予反馈"——一个诸事不顺的日子，有人打翻了托盘、有人算错了数、有人久疏练习。词表里有评价和安慰并存的表达：tough, poor thing, cheer, it's a good thing。你可以这样安慰：It's a good thing nobody got hurt. Everybody makes errors from time to time. You must have been out of practice—don't worry, you'll catch up.（幸好没人受伤。每个人时不时都会犯错。你肯定是久疏练习了——别担心，你会赶上来的。）

must have / must not have 是对过去事情的推测："一定是……""一定没……"。not quite（不完全是）、out of practice（生疏了）让反馈更委婉。catch up（赶上）、cheer（振作）给出积极的收尾。calculator, tray, stain 这些具体名词让"糟糕的一天"有了画面。

学完本单元，你能用英语对别人的失误给出既诚实又体贴的反馈，表达理解和鼓励。

## Tips

- **must have / must not have** — 对过去的肯定/否定推测。He must have forgotten. = 他一定是忘了。She must not have seen it. = 她一定没看到。注意 must have done 结构，不能说 must did。

- **out of practice** — "生疏了、久疏练习"。I'm out of practice—I haven't played in months. 反义词 in practice / in shape。practice 在这里指"练习的状态"，不是"实践"。

- **it's a good thing** — "幸好、好在"。It's a good thing you brought an umbrella. 比 fortunately 更口语。后面常接 (that) 从句。类似表达：It's a good job...（英式）。

- **from time to time** — "时不时、偶尔"。Everybody makes mistakes from time to time. 比 sometimes 更有"间隔性"的感觉。类似：now and then / once in a while。

- **catch up** — "赶上、追上"。catch up on work / catch up with the class。暗示"落后了，现在要补回来"。也可以指"叙旧"：Let's catch up over coffee. 非常高频的短语动词。

- **poor thing** — "可怜的家伙"，表达同情。Oh, poor thing! Did you have a bad day? 注意不是贬义，而是心疼。也可以说 poor you / poor him。thing 在这里指人，带有亲昵感。

- **tough** — "艰难的、棘手的"。a tough day / a tough situation。比 hard 更口语，比 difficult 更有"需要咬牙扛"的感觉。也可以形容人"坚强"：She's tough.

- **not quite** — "不完全是、差一点"。It's not quite right. / I'm not quite ready. 比 not exactly 语气更柔和。quite 在这里 = 完全，not quite = 没完全到位。

- **hard time** — "困难时期、艰难"。搭配：have a hard time / go through a hard time。I had a hard time catching up. 比 difficult period 更口语。注意 time 前没有 a 也可以：have hard times。

- **cheer** — "振作、欢呼"。cheer up = 振作起来。Cheer up! It's not that bad. 作名词：a cheer from the crowd。在安慰语境中，cheer up 是最常用的鼓励短语之一。

- **error** — "错误"，比 mistake 更正式。a calculation error / human error。在技术和学术语境中更常见。搭配：make an error / an error in judgment。注意和 err（犯错，动词）同源。

- **badly** — "严重地、非常"。He was badly hurt. / I badly need a break. 比 very 更强调"程度深且负面"。注意 badly 不总是"坏地"：I want it badly = 我非常想要。

- **effort** — "努力"。搭配：make an effort / put effort into / It takes effort。比 try 更强调"付出的精力"。注意 make an effort 中 effort 前通常有 an。

- **stain** — "污渍、污点"。a coffee stain / a stain on the shirt。动词：The wine stained the tablecloth. 比喻义：a stain on his reputation（名誉污点）。注意和 spot（斑点）区分。

- **tray** — "托盘"。搭配：a serving tray / carry a tray。在餐厅或咖啡厅场景中常见。注意拼写：tr-ay，和 tray 相关的词是 trayful（一托盘的量）。

- **calculator** — "计算器"。由 calculate（计算）+ -or（工具）组成。搭配：use a calculator / a scientific calculator。注意 -or 结尾，不是 -er。

- **break** — 本单元中可能指"休息"或"打碎"。take a break = 休息一下。break a glass = 打碎玻璃。一词多义，具体看搭配。在"糟糕的一天"语境下两种意思都可能出现。

- **see** — 除"看见"外，常表"明白、理解"。Oh, I see. = 哦，我明白了。在反馈语境中：I see what you mean. 比 understand 更口语、更即时。
