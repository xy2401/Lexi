...
> Tourism: Share your travel preferences
...
"Cruise"（邮轮旅行）来自荷兰语"kruisen"（交叉航行），与"cross"（交叉）同源。最早的cruise并非休闲活动，而是海军的巡逻航行——军舰在海域中"交叉往返"以监视敌情。十九世纪末，航运公司发现空船回程是浪费，于是开始向乘客出售"巡游"票，邮轮旅游由此诞生。"Hostel"（青年旅舍）来自拉丁语"hospitale"（招待所），与"hospital"（医院）和"hotel"（酒店）同源——三者都是"接待旅人"的场所，只是服务对象和条件不同。
...
- "Wherever"（无论哪里）是"where"+"ever"的组合，表达无限制的开放性：Wherever you want to go.（无论你想去哪里。）
- "Ferry"（渡轮）来自古英语"ferian"（运送），与"fare"（费用）同源——ferry是"运送人过河"的工具，fare是"为运送付出的代价"。
