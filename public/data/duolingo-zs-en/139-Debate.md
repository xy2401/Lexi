...
> Debate: Share your thoughts on solutions
...
"Media"（媒体）是拉丁语"medium"（中间物）的复数形式。媒体的本质就是"中间人"——在事件和公众之间传递信息。从古罗马广场上的公告板（Acta Diurna），到15世纪古腾堡的印刷术，到19世纪的电报，再到21世纪的社交媒体，media的形式不断变化，但"连接两端"的本质从未改变。"Opinion"（观点）来自拉丁语"opinari"（认为），与"optare"（选择）有远亲关系——持有观点就是"选择"一种立场。

"Argue"（争论）来自拉丁语"arguere"（使明亮、证明），与"argentum"（银）有远亲关系——银是"明亮的金属"，而argue的原意是"把道理说清楚、说亮堂"。"Solve"（解决）来自拉丁语"solvere"（松开、解开），与"soluble"（可溶的）同源——解决问题就是"解开"纠缠的结。古罗马人把"solvere"用于解开绳结、解除债务、溶解物质，一个词涵盖了所有"从束缚中释放"的场景。
...
- "Extremely"（极其）来自拉丁语"extremus"（最外面的），与"extreme"（极端的）同源——"极其"就是"到了最外面的边界"。
- "Mind"（介意/头脑）来自古英语"gemynd"（记忆），与"memory"同源——"Do you mind?"字面意思是"你记得/在意吗？"
- "Make up"（编造/和解）一词多义：编造故事是"凭空制造"，和解是"把破碎的关系重新拼好"——同一个短语，一破一立。
