...
> Old Friend: Catch up with someone
...
"Kindergarten"（幼儿园）是一个直接借入英语的德语词，由"Friedrich Fröbel"在1840年创造，字面意思是"儿童的花园"（Kinder = 孩子们，Garten = 花园）。Fröbel的教育理念是把孩子比作植物，老师是园丁，教育是"培育"而非"灌输"。当老朋友聊起"back in kindergarten"（幼儿园那会儿），时间瞬间被压缩——那个在花园里玩泥巴的孩子，如今已经"in their forties"（四十多岁了）。
...
- "Get used to"（习惯于）中的"used"不是"使用"的过去式，而是来自古英语"wunian"（居住），习惯就是"安居于某种状态"。
- "So far"（到目前为止）是英语中描述"现阶段"的常用短语，暗示未来可能变化："So far, so good."
- "Promise to"（答应要...）在老友重逢中常用于告别时的承诺："Promise to call more often"（答应我多打电话），虽然双方都知道这个承诺的保质期。
