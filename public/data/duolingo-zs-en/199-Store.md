...
"Silk"（丝绸）是人类最古老的奢华面料。中国养蚕缫丝的历史超过5000年，丝绸曾是比黄金还贵重的贸易商品。"丝绸之路"（Silk Road）连接了东西方文明，罗马贵族对中国丝绸的狂热甚至引发了元老院的禁令——他们认为丝绸太透明，有伤风化。"Diamond"（钻石）来自希腊语"adamas"（不可征服的），是自然界最坚硬的物质。钻石作为爱情象征的历史其实很短——1947年戴比尔斯公司的广告语"A Diamond is Forever"才真正建立了这个文化关联。
...
- "Off"在折扣语境中表示"减去"：20% off = 打八折（减去20%）。
- "Thick"（厚的）的反义词是"thin"（薄的），形容面料时很常用。
- "Would / wouldn't"在请求中表达礼貌：Would you exchange this for me? / I wouldn't recommend this fabric.
