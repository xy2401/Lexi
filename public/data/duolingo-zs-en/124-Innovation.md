...
> Innovation: Share thoughts about websites
...
"Link"（链接）在互联网语境中是"hyperlink"（超链接）的简称。1989年，在欧洲核子研究中心（CERN）工作的英国科学家Tim Berners-Lee提出了万维网的构想，其核心就是"超链接"——让任何文档都能与任何其他文档相连。这个看似简单的概念彻底改变了人类获取知识的方式。"Link"本身来自古英语"hlencan"（链条的一环），从铁链到超链接，人类连接事物的方式跨越了千年。

"Delete"（删除）来自拉丁语"delere"，意为"毁灭、抹去"。古罗马人用蜡板书写，写错了就用刮刀把蜡刮平——这就是最早的"delete"。有趣的是，拉丁语"delere"与"delirium"（谵妄）共享词根："de-"（离开）+"lira"（犁沟），字面意思是"偏离犁沟"，即"脱轨"。删除文字就是让它"脱轨"，消失不见。"Attachment"（附件）则来自古法语"atachier"（系紧），原意是用绳子把东西"绑"在信件上——电子邮件附件就是数字时代的"绑在信上的东西"。
...
- "Topic"（话题）来自希腊语"topos"（地方），亚里士多德的《论题篇》（Topica）讨论了如何从不同"位置"找到论点。
- "By accident"（偶然地）中"accident"来自拉丁语"accidere"（降临），原意是"意外降临的事"，与"incident"（事件）同源。
- "Reply"（回复）来自拉丁语"replicare"（折回），与"replica"（复制品）同源——回复就是把对话"折回"给说话者。
